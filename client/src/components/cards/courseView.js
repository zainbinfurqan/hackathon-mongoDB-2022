...
function CourseViewCard({ item, ...props }) {
    return (
        <div class="m-2 max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-5">
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{item.details}</p>
                <p class="mb-1 font-normal text-sm text-gray-700 dark:text-gray-400">Created by <span className='text-blue-700'>{item.instructor}</span></p>
                ...
                <p class="mb-3 font-normal text-sm text-gray-700 dark:text-gray-400">Rating <span className='text-blue-700'>{item.rating}</span></p>
