                    ...
                    {props.tableBody.map((item, index) => {
                        return (
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                {props.tableHeader.map(item_ => {
                                    return item_ !== 'actions' ?
                                        <td class="py-4 px-6">
                                            {item[item_]}
                                        </td> : <td className='flex self-center'>
                                            <div className='py-4 px-2 self-center text-red-600 cursor-pointer'>DELETE</div>
                                            <div className='py-4 px-2 self-center text-blue-600 cursor-pointer'>EDIT</div>
                                        </td>
                                })}
